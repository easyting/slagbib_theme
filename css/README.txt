...
To use these stylesheets, rename the files and slagbib with the name of your theme.
...
slagbib-alpha-default-narrow.css  
...
slagbib-alpha-default-normal.css
...
slagbib-alpha-default-wide.css
